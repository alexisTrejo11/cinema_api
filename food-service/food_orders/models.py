...
class SalesReport(models.Model):
    ...
    details = models.JSONField(default=dict)  # Store detailed breakdown by product/category
    created_at = models.DateTimeField(auto_now_add=True)

    def __str__(self):
        return f"{self.report_type} Sales Report ({self.start_date.date()} to {self.end_date.date()})"