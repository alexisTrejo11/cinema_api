    ...
    try:
        with transaction.atomic():
            ...
            payment_stats = payments.aggregate(
                total_sales=Sum('amount') or Decimal('0'),
                total_orders=Count('id'),
                avg_order_value=Avg('amount') or Decimal('0'),
                total_refunds=Sum('refund_amount') or Decimal('0')
            )
            ...
            report.total_sales = payment_stats['total_sales']
            report.total_orders = payment_stats['total_orders']
            report.average_order_value = payment_stats['avg_order_value']
            report.total_refunds = payment_stats['total_refunds']
            ...
            # Aquí podrías agregar notificación por email al usuario
